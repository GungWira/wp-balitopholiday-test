...
$trustindex_pm_tripadvisor = new TrustindexPlugin_tripadvisor("tripadvisor", __FILE__, "13.2.5", "WP Tripadvisor Review Widgets", "Tripadvisor");
...
require_once(__DIR__ . '/include/elementor-widgets.php');
$widgetsManager->register(new \Elementor\TrustrindexElementorWidget_Tripadvisor([], [$pluginManagerInstance]));
}
});
...
require_once(__DIR__ . '/include/elementor-widgets.php');
$widgetsManager->register_widget_type(new \Elementor\TrustrindexElementorWidget_Tripadvisor([], [$pluginManagerInstance]));
}
});
...
echo wp_kses_post(sprintf(__('Download our new <a href="%1$s" target="_blank">%2$s</a> plugin and get features for free!', 'review-widgets-for-tripadvisor'), 'https://wordpress.org/plugins/customer-reviews-collector-for-woocommerce/', 'Customer Reviews Collector for WooCommerce'));
?></strong></p>
<ul style="list-style-type: disc; margin-left: 10px; padding-left: 15px">
<li><?php echo esc_html(__('Send unlimited review invitations for free', 'review-widgets-for-tripadvisor')); ?></li>
<li><?php echo esc_html(__('E-mail templates are fully customizable', 'review-widgets-for-tripadvisor')); ?></li>
<li><?php echo esc_html(__('Collect reviews on 100+ review platforms (Google, Facebook, Yelp, etc.)', 'review-widgets-for-tripadvisor')); ?></li>
</ul>
<p>
<a href="<?php echo esc_url(wp_nonce_url(admin_url("admin.php?page=review-widgets-for-tripadvisor/settings.php&wc_notification=open"), 'ti-wc-notification')); ?>" target="_blank" class="ti-close-notification" style="text-decoration: none">
<button class="button button-primary"><?php echo esc_html(__('Download plugin', 'review-widgets-for-tripadvisor')); ?></button>
</a>
<a href="<?php echo esc_url(wp_nonce_url(admin_url("admin.php?page=review-widgets-for-tripadvisor/settings.php&wc_notification=hide"), 'ti-wc-notification')); ?>"target="_blank" class="ti-hide-notification" style="text-decoration: none">
<button class="button button-secondary"><?php echo esc_html(__('Do not remind me again', 'review-widgets-for-tripadvisor')); ?></button>
</a>
</p>
</div>
<?php
...
<button class="button ti-button-primary button-primary">'. esc_html(__('Write a review', 'review-widgets-for-tripadvisor')) .'</button>
</a>
...
'. esc_html(__('Maybe later', 'review-widgets-for-tripadvisor')) .'
</a>
...
'. esc_html(__('Do not remind me again', 'review-widgets-for-tripadvisor')) .'
</a>
';
}
else {
...
'. esc_html(__('Remind me later', 'review-widgets-for-tripadvisor')) .'
</a>';
}
}
echo '
