...
class Wp_Travel_Engine_Place_Order {
	...
	function wp_travel_engine_place_order_shortcodes_callback() {
		...
		if ( defined( 'WTE_USE_OLD_BOOKING_PROCESS' ) && WTE_USE_OLD_BOOKING_PROCESS ) :
			wp_die( new WP_Error( 'WTE_FUNCTIONALITY_NOT_AVAILABLE', esc_html__( 'Old Booking Process functionality has been removed since Travel Primakara 5.3.1.', 'wp-travel-engine' ) ) );
