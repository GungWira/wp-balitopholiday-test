...
function wpte_register_privacy_policy_template() {
	...
	wp_add_privacy_policy_content( 'Travel Primakara', wpautop( $content ) );
}
...
function register_wp_travel_engine_plugin_eraser( $erasers = array() ) {
	$erasers[] = array(
		'eraser_friendly_name' => __( 'Travel Primakara', 'wp-travel-engine' ),
...
function register_wp_travel_engine_plugin_exporter( $exporters ) {
	$exporters[] = array(
		'exporter_friendly_name' => __( 'Travel Primakara', 'wp-travel-engine' ),
...
/**
 * Travel Primakara Post Duplicator.
 *
