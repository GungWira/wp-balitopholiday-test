		...
		if ( 'partial-payment' === $extension ) {
			...
			$fields = array(
				...
				array(
					'field'      => array(
						'type'    => 'ALERT',
						'content' => __( 'Partial Payment is disabled. Please enable Partial Payment via <strong>Travel Primakara > Settings > Extensions > Partial Payment.</strong>', 'wp-travel-engine' ),
					),
		...
		if ( 'file-downloads' === $extension ) {
			...
			$fields = array(
				...
				array(
					'field'      => array(
						'type'    => 'ALERT',
						'content' => __( 'You can add, edit and delete the global files via <strong>Travel Primakara > Settings > Extensions > File Downloads.</strong> <a href="' . admin_url() . 'edit.php?post_type=booking&page=class-wp-travel-engine-admin.php#extension-file-downloads">Go To Settings</a>', 'wp-travel-engine' ),
						'status'  => 'notice',
					),
					'visibility' => wptravelengine_is_addon_active( 'file-downloads' ),
				),
		...
		if ( 'extra-services' === $extension ) {
			...
			$fields = array(
				...
				array(
					'field'      => array(
						'type'    => 'ALERT',
						'content' => __( '<strong>NOTE:</strong> You can add, edit and delete the global extra services via <strong>Travel Primakara > Extra Services</strong>.', 'wp-travel-engine' ),
						'status'  => 'notice',
					),
					'visibility' => wptravelengine_is_addon_active( 'extra-services' ),
				),
		...
		if ( 'itinerary-downloader' === $extension ) {
			$fields = array(
				...
				array(
					...
					'field'      => array(
						'type'    => 'ALERT',
						'content' => __( '<strong>NOTE:</strong> Want travellers to download the tour details in PDF format and read later? You can configure Itinerary Downloader via <b>Travel Primakara &gt; Settings &gt; Extensions &gt; Itinerary Downloader', 'wp-travel-engine' ),
						'status'  => 'info',
					),
				),
			);
