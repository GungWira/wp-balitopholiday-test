...
final class Plugin {
						...
						add_action(
							...
							function () use ( $plugin_name ) {
								printf(
									...
									esc_html( sprintf( __( '%1$s has been automatically deactivated, the feature providing by the plugin is now available in the Travel Primakara Core.', 'wp-travel-engine' ), $plugin_name ) ),
	...
	/**
	 * Additional Travel Primakara headers for plugins and themes.
	 *
	...
	protected function load_dependencies() {
		...
		/**
		 * Travel Primakara Settings Class.
		 */
	...
	private function define_admin_hooks() {
		...
		/**
		 * This action is used to perform actions after the plugin is updated.
		 *
		 * @since 6.6.9
		 */
	 ...
	 * @param array  $hook_extra The hook extra data.
	 *
	 * @return void
	 * @since 6.6.9
	 */
