	...
	array(
		...
		'fields' => array(
			array(
				...
				'field_type' => 'ALERT',
				'content'    => sprintf(
					__( '<strong>Note: </strong>Looking to enhance your website with genuine trip reviews? Trip Reviews is the perfect extension for Travel Primakara users. %1$sGet Trip Reviews extension now%2$s.', 'wp-travel-engine' ),
							...
							array(
								...
								'fields'     => array(
									array(
										...
										'description' => __( 'Add the custom form shortcode. We have made Travel Primakara compatible with popular forms likes Gravity Form, Ninja Forms and WPForms.', 'wp-travel-engine' ),
										'field_type'  => 'TEXT',
