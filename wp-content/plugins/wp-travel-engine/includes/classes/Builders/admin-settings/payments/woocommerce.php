	...
	array(
		...
		'fields'    => array(
			...
			array(
				...
				'description' => __( 'Enabling this option will allow users to use WooCommerce Checkout and Payment Gateways to purchase/book trips.<br><strong>Note: </strong>This will also disable the default behavior of Travel Primakara of Trip Booking.', 'wp-travel-engine' ),
				'field_type'  => 'SWITCH',
			...
			array(
				'field_type' => 'ALERT',
				'content'    => sprintf(
					__( 'If you have enabled tax for Travel Primakara, You must configure tax settings for WooCommerce. %1$sView Documentation%2$s about setting up taxes.', 'wp-travel-engine' ),
