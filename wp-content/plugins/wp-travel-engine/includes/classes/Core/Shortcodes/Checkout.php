...
class Checkout extends Shortcode {
	...
	public function output( $atts ): string {
		...
		if ( defined( 'WTE_USE_OLD_BOOKING_PROCESS' ) && WTE_USE_OLD_BOOKING_PROCESS ) :
			wp_die( new \WP_Error( 'WTE_FUNCTIONALITY_NOT_AVAILABLE', __( 'Old Booking Process functionality has been removed since Travel Primakara 5.3.1.', 'wp-travel-engine' ) ) );
