...
/**
 * Class Optimizer.
 * The class that handles the optimization of the Travel Primakara plugin.
 *
 * @since 6.0.5
 */
class Optimizer {
	...
	public static function add_lazyload_attributes( string $html ): string {
		// Check if the current page is a Travel Primakara single post and lazy loading is enabled.
