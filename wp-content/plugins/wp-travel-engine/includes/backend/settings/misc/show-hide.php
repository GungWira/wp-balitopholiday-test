	...
	<div class="wpte-form-block">
		<div class="wpte-form-content">
			...
			<span class="wpte-tooltip">
				...
				echo wp_kses(
					sprintf(
						__( 'Enable to use the new Full Site Editing (FSE) templates provided by Travel Primakara. For more details, refer to the %1$s documentation%2$s which guides you on how to set up these templates.', 'wp-travel-engine' ),
