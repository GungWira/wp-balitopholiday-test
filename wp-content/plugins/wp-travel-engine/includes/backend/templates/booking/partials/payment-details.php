...
$payment_edit_fields = PaymentEditFormFields::create( array( 'tax' => '0.00' ), 'edit', array( 'tax' => __( 'Tax', 'wp-travel-engine' ) ) );
...
<div class="wpte-form-section" data-target-id="payments" data-summary-info='<?php echo esc_attr( json_encode( array_keys( $extra_fields ) ) ); ?>'>
	<div class="wpte-accordion">
		...
		<div class="wpte-accordion-content" data-payments-section>
			<?php
	...
	<div class="wpte-payment-summary-card">
		...
		<table class="wpte-payment-summary-table">
			...
			<tr class="wpte-payment-summary-total wpte-payment-amount">
				...
				<td class="wpte-payment-summary-amount"><?php wptravelengine_the_price( $payments_total['total'], true, $pricing_arguments ); ?></td>
			</tr>
		</table>
	</div>
</script>