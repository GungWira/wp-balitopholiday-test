			...
			<div class="wpte-booked-trip-descriptions">
				<ul>
					...
					<li>
						...
						<span class="lrf-td-desc wpte-<?php echo esc_attr( $map[ $payment_status ] ); ?>"><?php echo esc_html( $payment_status ); ?></span>
					</li>
					<li>
						<span class="lrf-td-title"><?php echo sprintf( __( 'Total Amount:%s', 'wp-travel-engine' ), $booking_instance->is_curr_cart() ? __( '<br>(excl. extra fees)', 'wp-travel-engine' ) : '' ); ?></span>
						<span
