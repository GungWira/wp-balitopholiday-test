	...
	class WP_Travel_Engine_Admin_Permalink_Settings {
		...
		public function settings_init() {
			...
			add_settings_section(
				...
				__( 'Travel Primakara: Trip Slugs', 'wp-travel-engine' ),
		...
		public function wte_settings_section_perma( $args ) {
			echo '<p>' . esc_html__( 'You can change the permalink slug for Travel Primakara Trip default archive and all trip custom taxonomy archives from the settings section below.', 'wp-travel-engine' ) . '</p>';
		}
