	...
	'wpte-itinerary'               => array(
		...
		'fields'            => array(
			...
			array(
				...
				'field'      => [
					'type'    => 'ALERT',
					'content' => __( '<p>You can add, edit and delete sleep modes via <strong>Travel Primakara > Settings > Extensions > Advanced Itinerary Builder.</strong></p>', 'wp-travel-engine' ),
					'status'    => 'notice',
				],
			),
			array(
